...
const Weather = ({weather, temp}) => {
    ...
    <section className='text-xl'>
        <h2 className='text-center mb-4 font-blod text-2xl tracking-wider'>{weather.name}, {weather.sys.country}</h2>
        <section className='grid gap-4 sm:grid-cols-two'>
            <article className='bg-slate-300/70 rounded-3xl grid grid-cols-2 justify-items-center items-center py-2 sm:px-2git'>
        ...
        <button onClick={changeUnitTemp} className='bg-blue-500 py-2 py-2 px-6 text-white font-bo rounded-full hover:bg-blue-800 durtion-200 text-sm block mx-auto mt-4'>Change °C/°F</button>
    </section>
  )
}
